...
public class BookingTest {
    ...
    /**
     * Test of login method, of class Booking. Se busca un Vendedor cuyo idUsr y
     * contrasenia sabemos de antemano y comprobamos si se asigna a sesion.
     */
    @Test(expected = FailedLoginExc.class)
    public void testlogin() throws FailedLoginExc {
        try {
            b.login(0, "1234");
    ...
    /**
     * Test of buscarPaquete method, of class Booking. Se busca un paquete que
     * sabemos que existe, y lo comparamos con el original.
     */
    @Test
    ...
    /**
     * Test of buscarCliente method, of class Booking. Se busca un cliente que
     * sabemos que existe, y lo comparamos con el original.
     */
    @Test
    ...
    /**
     * Test of buscarVendedor method, of class Booking. Se busca un vendedor que
     * sabemos que existe, y lo comparamos con el original.
     */
    @Test
    ...
    /**
     * Test of crearPaquete method, of class Booking. Creamos un nuevo Paquete,
     * lo guardamos en la DB y a continuacion lo buscamos y lo comparamos con el
     * original.
     */
    @Test
...
//        admin.close();
    ...
    /**
     * Test of registrarCliente method, of class Booking. Creamos un nuevo
     * Cliente, lo guardamos en la DB y a continuacion lo buscamos y lo
    ...
    /**
     * Test of darAltaVendedor method, of class Booking. Creamos un nuevo
     * Vendedor, lo guardamos en la DB y a continuacion lo buscamos y lo
     * comparamos con el original.
     */
    @Test
    ...
    /**
     * Test of factVuelos method, of class Booking. Creamos un nuevo Paquete en
     * la BD con una sola Reserva confirmada de Vuelo y comprobamos que el
     * metodo factVuelos nos devuelve un valor mayor o igual que el precio
     * pagado del Paquete. NOTA: La facturacion está en constante cambio (si se
     * realizan 10 pruebas, se acabaran metiendo en la BD los mismos Paquetes
     * multiplicados por 10), por lo que las pruebas de Facturacion van a
     * terminar siendo algo ambiguas.
     */
    @Test
    ...
    /**
     * Test of factHoteles method, of class Booking. Creamos un nuevo Paquete en
     * la BD con una sola Reserva confirmada de Hotel y comprobamos que el
     * metodo factHoteles nos devuelve un valor mayor o igual que el precio
     * pagado del Paquete. NOTA: La facturacion está en constante cambio (si se
     * realizan 10 pruebas, se acabaran metiendo en la BD los mismos Paquetes
     * multiplicados por 10), por lo que las pruebas de Facturacion van a
     * terminar siendo algo ambiguas.
    ...
    /**
     * Test of factViajesOrg method, of class Booking. Creamos un nuevo Paquete
     * en la BD con una sola Reserva confirmada de Viaje Organizado y
     * comprobamos que el metodo factViajesOrg nos devuelve un valor mayor o
     * igual que el precio pagado del Paquete. NOTA: La facturacion está en
     * constante cambio (si se realizan 10 pruebas, se acabaran metiendo en la
     * BD los mismos Paquetes multiplicados por 10), por lo que las pruebas de
    ...
    /**
     * Test of factTotal method, of class Booking. Creamos un nuevo Vendedor y
     * un nuevo Paquete en la BD con dos Reservas confirmadas de distinto tipo y
     * comprobamos que el metodo factTotal nos devuelve un valor igual al precio
     * total pagado del Paquete (dicho Paquete sera el unico asociado a nuestro
     * nuevo Vendedor).
     */
    @Test
    ...
    /**
     * Test of factTotal method, of class Booking. Obtenemos las facturaciones
     * totales de todos los vendedores y comprobamos si la suma coincide con el
     * retorno de factTotal()
     */
    @Test
