...
public class VendedorTest {
    ...
    /**
     * Test of getPaquetes method, of class Vendedor. Creamos una lista de
     * paquetes (lleno) con los paquetes que hemos guardado en la BD
     * relacionados con el vendedor 1 (v1). Obtenemos los paquetes de la BD con
     * getPaquetes y comprobamos que coinciden.
     */
    @Test
    ...
    /**
     * Test of isAdmin method, of class Vendedor. Comprobamos que,
     * efectivamente, el método isAdmin() nos detecta si somos o no
     * administradores (incluso llamando al método desde un objeto de tipo
     * Vendedor que en tiempo de ejecución sea un Administrador).
     */
    @Test
     ...
     * de la clase Vendedor, comprobamos que podemos guardar objetos de dicha
