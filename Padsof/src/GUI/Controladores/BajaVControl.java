...
public class BajaVControl implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (fuente == vista.getAtras()) {
            ...
            int opc = -1;
            if (actual == null) {
                JOptionPane.showMessageDialog(vista, "Para dar de baja a un vendedor, antes debe"
                        + "buscarlo por su ID.",
                        "ERROR - Vendedor no seleccionado", JOptionPane.INFORMATION_MESSAGE);
            } else if (actual.getIdUsr() == 0) {
                JOptionPane.showMessageDialog(vista, "No se puede dar de baja a un administrador.",
                        "ERROR - Administrador imborrable", JOptionPane.INFORMATION_MESSAGE);
            } else {
                opc = JOptionPane.showConfirmDialog(vista, "¿Está seguro de querer dar de baja"
                        + " a este vendedor?",
    ...
    private void borrarVendedor() {
        try {
            ...
            JOptionPane.showMessageDialog(vista, "El vendedor especificado ha sido borrado correctamente.",
