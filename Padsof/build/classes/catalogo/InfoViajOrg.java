...
public class InfoViajOrg {
     ...
     * @return false - el viaje organizado no coincide con los campos disponibles
     * 
     * <u>Nota</u>:<br/>
     * Los par&aacute;metros que no queramos tener en cuenta los pondremos como 
     * -1 si es un n&uacute;mero, o como "" si es un String.
     */
    public boolean compareTo(String nombre, int dias, int noches,
        ...
        if(nombre.equals("") == false) {
            if(this.getNombre().equals(nombre) == false) {return false;}
        }
        
        else if(dias != -1) {
            if(dias != this.getDias()) {return false;}
        }
        
        else if(noches != -1) {
            if(noches != this.getNoches()) {return false;}
        }
        
        else if(precio != -1) {
            if(precio != this.getPrecio()) {return false;}
        }
        
        else if(localidades.equals("") == false) {
            if(localidades.equals(this.getLocalidades()) == false) {return false;}
        }
        
        else if(fechaSalida.equals("") == false) {
            if(fechaSalida.equals(this.getFechasSalida()) == false) {return false;}
        }
